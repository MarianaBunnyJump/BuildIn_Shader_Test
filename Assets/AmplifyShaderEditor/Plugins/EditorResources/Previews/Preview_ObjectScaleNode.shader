Shader "Hidden/ObjectScaleNode"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float3 objectScale = float3(length(unity_ObjectToWorld[0].xyz), length(unity_ObjectToWorld[1].xyz),
        ...
        Pass
        {
            ...
            float4 frag(v2f_img i) : SV_Target
            {
                float3 objectScale = 1.0 / float3(length(unity_WorldToObject[0].xyz),
