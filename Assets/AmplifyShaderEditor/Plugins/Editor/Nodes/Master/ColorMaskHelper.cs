...
namespace AmplifyShaderEditor
{
    ...
    {
        private GUIContent ColorMaskContent = new GUIContent("Color Mask",
        ...
        [SerializeField] private bool[] m_colorMask = { true, true, true, true };

        [SerializeField] private InlineProperty m_inlineMask = new InlineProperty();
        ...
        public void BuildColorMask(ref string ShaderBody, bool customBlendAvailable)
        {
            ...
            {
                MasterNode.AddRenderState(ref ShaderBody, "ColorMask",
                    m_inlineMask.GetValueOrProperty(((count == 0) ? "0" : colorMask)));
            }
        }
