...
namespace AmplifyShaderEditor
{
    ...
    public sealed class Vector3Node : PropertyNode
    {
        ...
        [SerializeField] private Vector3 m_materialValue = Vector3.zero;
        ...
        public Vector3Node(int uniqueId, float x, float y, float width, float height) : base(uniqueId, x, y, width,
            height)
        {
        }
        ...
        public override string GetPropertyValue()
        {
            return PropertyAttributes + m_propertyName + "(\"" + m_propertyInspectorName + "\", Vector) = (" +
                   m_defaultValue.x + "," + m_defaultValue.y + "," + m_defaultValue.z + ",0)";
        }
