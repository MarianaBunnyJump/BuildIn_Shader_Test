...
namespace AmplifyShaderEditor
{
    ...
    public sealed class FogAndAmbientColorsNode : ShaderVariablesNode
    {
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedType =
                (BuiltInFogAndAmbientColors)m_upperLeftWidget.DrawWidget(this, (int)m_selectedType, ColorValuesStr);
        ...
        public override void DrawProperties()
        {
            ...
            EditorGUI.BeginChangeCheck();
            m_selectedType =
                (BuiltInFogAndAmbientColors)EditorGUILayoutPopup(ColorLabelStr, (int)m_selectedType, ColorValuesStr);
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_selectedType = (BuiltInFogAndAmbientColors)Enum.Parse(typeof(BuiltInFogAndAmbientColors),
