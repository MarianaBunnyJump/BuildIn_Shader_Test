...
namespace AmplifyShaderEditor
{
    ...
    {
        [SerializeField] private BuiltInShaderClipPlanesTypes m_selectedType = BuiltInShaderClipPlanesTypes.Left;
        ...
        {
            x.SetAdditonalTitleText(string.Format(Constants.SubTitleTypeFormatStr,
                (x as CameraWorldClipPlanes).Type));
        };

        public BuiltInShaderClipPlanesTypes Type
        {
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_selectedType = (BuiltInShaderClipPlanesTypes)Enum.Parse(typeof(BuiltInShaderClipPlanesTypes),
