...
namespace AmplifyShaderEditor
{
    ...
    public sealed class CameraProjectionNode : ShaderVariablesNode
    {
        ...
        private readonly string[] _projMatrixValuesStr =
        {
            "Camera Projection",
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedType =
                (BuiltInShaderCameraTypes)m_upperLeftWidget.DrawWidget(this, (int)m_selectedType, _projMatrixValuesStr);
        ...
        public override void DrawProperties()
        {
            ...
            EditorGUI.BeginChangeCheck();
            m_selectedType =
                (BuiltInShaderCameraTypes)EditorGUILayoutPopup(_projMatrixLabelStr, (int)m_selectedType,
                    _projMatrixValuesStr);
            if (EditorGUI.EndChangeCheck())
            {
                ChangeOutputName(0, _projMatrixValuesStr[(int)m_selectedType]);
                SetSaveIsDirty();
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_selectedType =
                (BuiltInShaderCameraTypes)Enum.Parse(typeof(BuiltInShaderCameraTypes), GetCurrentParam(ref nodeParams));
            ChangeOutputName(0, _projMatrixValuesStr[(int)m_selectedType]);
        }
