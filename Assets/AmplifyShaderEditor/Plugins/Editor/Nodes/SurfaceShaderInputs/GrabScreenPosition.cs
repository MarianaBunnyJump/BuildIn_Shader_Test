...
{
    [Serializable]
    [NodeAttributes("Grab Screen Position", "Camera And Screen",
    ...
    public sealed class GrabScreenPosition : ParentNode
    {
            ...
            bool ignoreLocalVar)
        {
            ...
            if (m_outputTypeInt == 0)
                localVarName = GeneratorUtils.GenerateGrabScreenPositionNormalized(ref dataCollector, UniqueId,
                    CurrentPrecisionType, !dataCollector.UsingCustomScreenPos);
            else
                localVarName = GeneratorUtils.GenerateGrabScreenPosition(ref dataCollector, UniqueId,
                    CurrentPrecisionType, !dataCollector.UsingCustomScreenPos);
