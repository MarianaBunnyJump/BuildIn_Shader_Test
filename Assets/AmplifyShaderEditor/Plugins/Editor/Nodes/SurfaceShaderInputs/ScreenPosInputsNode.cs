...
{
    [Serializable]
    [NodeAttributes("Screen Position", "Camera And Screen",
    ...
    public sealed class ScreenPosInputsNode : SurfaceShaderINParentNode
    {
        ...
        [SerializeField] private int m_outputTypeInt = 0;

        [SerializeField] private bool m_scaleAndOffset = false;
        ...
        protected override void CommonInit(int uniqueId)
        {
            ...
            if (UIUtils.CurrentWindow != null && UIUtils.CurrentWindow.CurrentGraph != null &&
                UIUtils.CurrentShaderVersion() <= 2400)
            {
                m_outputTypeInt = 1;
            ...
            bool ignoreLocalVar)
        {
            ...
            if (m_outputTypeInt == 0)
            {
                ...
                {
                    screenPos = dataCollector.TemplateDataCollectorInstance
                        .GetScreenPosNormalized(CurrentPrecisionType);
                }
                else
                {
                    screenPos = GeneratorUtils.GenerateScreenPositionNormalized(ref dataCollector, UniqueId,
            ...
            else
            {
                ...
                {
                    screenPos = GeneratorUtils.GenerateScreenPosition(ref dataCollector, UniqueId,
                        CurrentPrecisionType);
                }
            }
