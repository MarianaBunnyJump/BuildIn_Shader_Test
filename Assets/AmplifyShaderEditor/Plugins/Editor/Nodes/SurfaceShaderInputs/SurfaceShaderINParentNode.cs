...
namespace AmplifyShaderEditor
{
    ...
    {
        [SerializeField] protected SurfaceInputs m_currentInput;

        [SerializeField] protected string m_currentInputValueStr;

        [SerializeField] protected string m_currentInputDecStr;
