...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateMultiPassSwitchNode : TemplateNodeParent
    {
        ...
        [SerializeField] private List<InputSwitchMPHelper> m_inputHelper = new List<InputSwitchMPHelper>();

        [SerializeField] private int m_inputCountHelper = -1;
        ...
        public override void OnConnectedOutputNodeChanges(int inputPortId, int otherNodeId, int otherPortId,
                        ...
                        for (int passIdx = 0; passIdx < passCount; passIdx++)
                        {
                            if (m_templateMPData.SubShaders[subShaderIdx].Passes[passIdx].HasValidFunctionBody)
                            {
                                AddInputPort(WirePortDataType.FLOAT, false,
                                    string.Format(InputLabelStr, subShaderIdx, passIdx));
                                m_inputHelper.Add(new InputSwitchMPHelper(subShaderIdx, passIdx));
