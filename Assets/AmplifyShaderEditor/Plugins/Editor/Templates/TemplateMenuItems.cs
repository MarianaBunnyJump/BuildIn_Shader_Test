...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/UnlitDoublePass", false, 85 )]
		public static void ApplyTemplateTemplatesUnlitDoublePass()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "7b276a967c30e174da928091844f5fab" );
		}
	}
}
