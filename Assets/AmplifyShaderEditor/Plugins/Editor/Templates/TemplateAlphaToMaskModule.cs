...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateAlphaToMaskModule : TemplateModuleParent
    {
        ...
        [SerializeField] private bool m_alphaToMask = false;

        [SerializeField] private InlineProperty m_inlineAlphaToMask = new InlineProperty();
        ...
        public override void Draw(UndoParentNode owner, bool style = true)
        {
            ...
            m_inlineAlphaToMask.CustomDrawer(ref owner,
                (x) => { m_alphaToMask = owner.EditorGUILayoutToggle(AlphaToMaskStr, m_alphaToMask); }, AlphaToMaskStr);
        ...
        public InlineProperty AlphaToMaskInlineProperty
        {
            get { return m_inlineAlphaToMask; }
        }
    }
}