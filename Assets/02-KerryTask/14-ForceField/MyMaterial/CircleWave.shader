...
Shader "CircleWave"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult14 = clamp( ( ( ( temp_output_6_0 - ( _HitSize * frac( _Time.y ) ) ) + ( tex2D( _Noise, i.uv_texcoord ).r * _HitNoiseIntensity ) ) / _HitSpread ) , -1.0 , 0.0 );
...
/*ASEBEGIN
Version=18500
0;0;1920;1011;1815.615;839.0635;1.711971;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1706.355,-0.9987707;Inherit;False;Property;_HitSize;HitSize;5;0;Create;True;0;0;False;0;False;6.066939;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;27;-1687.283,97.93397;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;6;-1476.458,-283.4479;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-1500.184,38.83398;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-1232.247,539.5392;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;9;-1212.665,-201.2021;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-987.4845,443.2207;Inherit;False;Property;_HitSpread;HitSpread;1;0;Create;True;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-1013.18,186.7088;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;13;-745.8609,359.1333;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;14;-627.9963,385.9003;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;259.719,-108.4713;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=70BEB5E08D27E9313E688DAB7D27C224F1A245C5