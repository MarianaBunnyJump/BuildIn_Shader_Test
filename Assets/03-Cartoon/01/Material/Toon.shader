Shader "Toon"
{
    Properties
    {
        ...
        _SSSMap("SSS Map",2D) = "black"{}//次表面散射
        _ILMMap("ILM",2D) = "gray" {}
        ...
        _OutlineWidth("OutLineWidth",Float) = 7.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                //ilm贴图  以0.5为分界点，低于0.5阴影部分不会随着光照偏移
                ...
                half toon_diffuse = saturate((labmbert_term - _ToonThreshold) * _ToonHardness);
                ...
                half3 detail_color = tex2D(_DetailMap, uv2); //第二套UV采样detailmap
                ...
                half3 final_rimlight = toon_rimlight * rim_color * base_mask * toon_diffuse * _RimLightColor.a;
                //toon_diffuse光色阶化
